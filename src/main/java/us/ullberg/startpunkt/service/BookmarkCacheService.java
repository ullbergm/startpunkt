 ...
 *
 * <p>This service stores BookmarkResponse objects in a thread-safe map, indexed by a composite key
 * of namespace + resource name. The cache is populated on startup and updated by Kubernetes watch
 * handlers.
 *
