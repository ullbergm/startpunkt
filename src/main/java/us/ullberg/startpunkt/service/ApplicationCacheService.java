 ...
 *
 * <p>
 * This service stores ApplicationResponse objects in a thread-safe map, indexed
 * by a composite
 * key of namespace + resource name + source type. The cache is populated on
 * startup and updated by
