...
class ApplicationTest {
  ...
  void testEqualityAndHashCode() {
    Application app1 = new Application(
        "AppA", "GroupA", "icon", "red", "https://a.com", "info", true, 0, true);
  ...
  @Test
  void testInequality() {
    Application app1 = new Application("App1", "Group1", "icon", "blue", "url1", "info1", true, 0, true);
    Application app2 = new Application("App2", "Group2", "icon", "red", "url2", "info2", false, 1, false);
  ...
  void testToStringContainsKeyFields() {
    Application app = new Application("AppZ", "GroupZ", "mdi:z", "black", "https://z.com", "Z info", true, 99, true);
