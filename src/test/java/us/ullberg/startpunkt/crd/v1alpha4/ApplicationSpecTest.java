...
class ApplicationSpecTest {
  ...
  void testHashCodeIncludesAllFields() {
    ApplicationSpec spec1 = new ApplicationSpec("App", "Group", "icon", "color", "url", "info", true, 5, true, "/path", "tags");
    UrlFrom urlFrom = new UrlFrom("core", "v1", "Service", "svc", "default", "spec.host");
    spec1.setUrlFrom(urlFrom);
    
    ApplicationSpec spec2 = new ApplicationSpec("App", "Group", "icon", "color", "url", "info", true, 5, true, "/path", "tags");
  ...
  void testEqualsWithDifferentClass() {
    ApplicationSpec spec = new ApplicationSpec("App", "Group", null, null, "url", null, true, 0, true);
  ...
  void testCompareToEdgeCases() {
    ApplicationSpec spec1 = new ApplicationSpec("Alpha", "A", null, null, "url", null, true, 1, true);
    ApplicationSpec spec2 = new ApplicationSpec("Beta", "A", null, null, "url", null, true, 1, true);
    ApplicationSpec spec3 = new ApplicationSpec("Alpha", "B", null, null, "url", null, true, 1, true);
  ...
  void testEqualsWithPartiallyNullFields() {
    ApplicationSpec spec1 = new ApplicationSpec("App", null, null, null, "url", null, null, 0, null);
    ApplicationSpec spec2 = new ApplicationSpec("App", null, null, null, "url", null, null, 0, null);
  ...
  void testInequalityOnEachField() {
    ApplicationSpec base = new ApplicationSpec("App", "Group", "icon", "color", "url", "info", true, 5, true, "/path", "tags");
    
    ApplicationSpec diffName = new ApplicationSpec("Other", "Group", "icon", "color", "url", "info", true, 5, true, "/path", "tags");
    ApplicationSpec diffGroup = new ApplicationSpec("App", "Other", "icon", "color", "url", "info", true, 5, true, "/path", "tags");
    ApplicationSpec diffIcon = new ApplicationSpec("App", "Group", "other", "color", "url", "info", true, 5, true, "/path", "tags");
    ApplicationSpec diffColor = new ApplicationSpec("App", "Group", "icon", "other", "url", "info", true, 5, true, "/path", "tags");
    ApplicationSpec diffUrl = new ApplicationSpec("App", "Group", "icon", "color", "other", "info", true, 5, true, "/path", "tags");
    ApplicationSpec diffInfo = new ApplicationSpec("App", "Group", "icon", "color", "url", "other", true, 5, true, "/path", "tags");
    ApplicationSpec diffTarget = new ApplicationSpec("App", "Group", "icon", "color", "url", "info", false, 5, true, "/path", "tags");
    ApplicationSpec diffLocation = new ApplicationSpec("App", "Group", "icon", "color", "url", "info", true, 10, true, "/path", "tags");
    ApplicationSpec diffEnabled = new ApplicationSpec("App", "Group", "icon", "color", "url", "info", true, 5, false, "/path", "tags");
    ApplicationSpec diffPath = new ApplicationSpec("App", "Group", "icon", "color", "url", "info", true, 5, true, "/other", "tags");
    ApplicationSpec diffTags = new ApplicationSpec("App", "Group", "icon", "color", "url", "info", true, 5, true, "/path", "other");
  ...
  void testLocationNegativeValue() {
    ApplicationSpec spec = new ApplicationSpec("App", "Group", null, null, "url", null, true, -1, true);
    assertEquals(-1, spec.getLocation());
    
    ApplicationSpec spec2 = new ApplicationSpec("App", "Group", null, null, "url", null, true, 0, true);
