...
class ThemeResourceTest {
  ...
  void testLightThemeConfiguration() {
    given()
        ...
        .get("/api/theme")
        .then()
        .body("light.bodyBgColor", equalTo("#F8F6F1"))
        .body("light.bodyColor", equalTo("#696969"))
        .body("light.emphasisColor", equalTo("#000000"))
  ...
  void testDarkThemeConfiguration() {
    given()
        ...
        .get("/api/theme")
        .then()
        .body("dark.bodyBgColor", equalTo("#232530"))
        .body("dark.bodyColor", equalTo("#696969"))
        .body("dark.emphasisColor", equalTo("#FAB795"))
