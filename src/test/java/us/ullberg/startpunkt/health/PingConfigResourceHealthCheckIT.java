...
public class PingConfigResourceHealthCheckIT extends PingConfigResourceHealthCheckTest {
  // This class executes the same tests as PingConfigResourceHealthCheckTest but in packaged
  // mode.
