...
public class PingThemeResourceHealthCheckIT extends PingThemeResourceHealthCheckTest {
  // This class executes the same tests as PingThemeResourceHealthCheckTest but in packaged
  // mode.
